    ...
    <>
      ...
      <footer className="bg-black text-white py-12 md:py-16 px-4 font-semibold text-xl">
        ...
        <div className="container mx-auto mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row gap-4 justify-between items-center">
          <p className="text-gray-100 text-sm text-center md:text-left">©  {new Date().getFullYear()} All rights reserved</p>
          <div className="flex gap-4">
            <Link href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram" className="hover:text-blue-600 transition-colors text-white">
              ...
              <Link href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook" className="hover:text-blue-600 transition-colors text-white">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
