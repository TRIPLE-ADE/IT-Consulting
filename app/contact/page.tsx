      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              <div className="mb-8">
                <h2 className="text-4xl font-bold text-gray-900 mb-4">We Love to Hear From You</h2>
              ...
              <Card className="border-0 shadow-none">
                <CardContent className="p-0">
                  <form className="space-y-6">
                    <div>
                      <Input type="text" placeholder="First Name:" className="bg-gray-50 border-gray-200 h-12 text-base" />
                    </div>
                    <div>
                      <Input type="email" placeholder="Your mail:" className="bg-gray-50 border-gray-200 h-12 text-base" />
                    </div>
                    <div>
                      <Input type="text" placeholder="Subject:" className="bg-gray-50 border-gray-200 h-12 text-base" />
                    </div>
                    <div>
                      <Textarea placeholder="Message:" className="bg-gray-50 border-gray-200 min-h-[150px] text-base resize-none" />
                    </div>
            ...
            <div className="space-y-12">
              <Card className="border-0 shadow-none">
                <CardContent className="p-0">
                  <h3 className="text-xl font-bold text-gray-800 mb-8 uppercase tracking-wide">CONTACT DETAILS</h3>
              ...
              <Card className="border-0 shadow-none overflow-hidden">
                <CardContent className="p-0">
                   <h3 className="text-xl font-bold text-gray-800 mb-6 uppercase tracking-wide">MAP</h3>
